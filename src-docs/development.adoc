...
===== What
We look for enabling the following points when we set up static code analysis:
...
** Cyclomatic complexity of classes and methods
** Layering and overall architecture outline (e.g. GUI layer should not call DB directly. )
